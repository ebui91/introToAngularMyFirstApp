angular.module("angularFriends").controller("myCtrl", function($scope){
  $scope.test= "ANGULAR FOR FRIENDS";
...
let friends= [{"id":1,"first_name":"Kirsteni","last_name":"Dunseath","email":"kdunseath0@hubpages.com","gender":"Female","img_url":"https://robohash.org/odioconsequaturomnis.jpg?size=50x50&set=set1"},
